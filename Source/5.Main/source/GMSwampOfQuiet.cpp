...
// 		}
	...
	case 445:
		...
		strcpy(pCharacter->ID,"çµé­‚é¢†ä¸» ³ªÀÌÆ®");
		pCharacter->Object.Scale = 1.1f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		pCharacter->Object.LifeTime = 100;
	...
	case 446:
		...
		strcpy(pCharacter->ID,"çµé­‚é¢†ä¸» é­‚");
	...
	case 559:
		...
		strcpy(pCharacter->ID,"çµé­‚é¢†ä¸» ¸¶½ºÅÍ");
