...
void CheckChatText(char *Text)
{
	...
	else if(FindText(Text,"T_T") || FindText(Text,"-_-") || FindText(Text,"T_T") || FindText(Text,GlobalText[306]) || FindText(Text,GlobalText[307]) || FindText(Text,GlobalText[308]) || FindText(Text,GlobalText[309]))
	{
		SetActionClass(c,o,PLAYER_CRY1,AT_CRY1);
		SendRequestAction(AT_CRY1,((BYTE)((o->Angle[2]+22.5f)/360.f*8.f+1.f)%8));
	}
	else if(FindText(Text,"T_T") || FindText(Text,"T_T") || FindText(Text,"T_T") || FindText(Text,"-.-") || FindText(Text,"-_-") || FindText(Text,GlobalText[310]) || FindText(Text,GlobalText[311]))
	{
	...
	else if(FindText(Text,GlobalText[342]) || FindText(Text,GlobalText[343]) || FindText(Text,"/TT") || FindText(Text,"TT"))
	{
