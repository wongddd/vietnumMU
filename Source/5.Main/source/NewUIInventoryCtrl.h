...
namespace SEASON3B
{
	...
	public:
		...
		int FindEmptySlot(IN int cx, IN int cy, bool Ext =false);	//. return lineal position
		...
		bool HidenRenderNumber;
	};
}

#define g_pPickedItem SEASON3B::CNewUIInventoryCtrl::GetPickedItem()
#define g_pCheckIsToolTip SEASON3B::CNewUIInventoryCtrl::CheckIsToolTip()
