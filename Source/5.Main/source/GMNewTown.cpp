...
CHARACTER* GMNewTown::CreateNewTownMonster(int iType, int PosX, int PosY, int Key)
{
	...
	case 418:
		...
		strcpy(pCharacter->ID,"è›®åŠ›å·¨äºº");
	...
	case 419:
		...
		strcpy(pCharacter->ID,"ç«ç„°å·¨äºº");
	...
	case 421:
		...
		strcpy(pCharacter->ID,"ç‹‚æš´æˆ˜å£«");
	...
	case 422:
		...
		strcpy(pCharacter->ID,"è¿œå¤å®ˆæŠ¤è€…");
		pCharacter->Object.Scale = 1.0f * 0.95f;
		pCharacter->Weapon[0].Type = -1;
		pCharacter->Weapon[1].Type = -1;
		break;
	...
	case 424:
		...
		strcpy(pCharacter->ID,"ç²¾çµå®ˆå«");
	...
	case 425:
		...
		strcpy(pCharacter->ID,"ç²¾çµå®ˆå« ´ëÀå");
