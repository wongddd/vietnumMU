...
extern _ITEM_TOOLTIP tooltip_data[MAX_ITEM];
extern _ITEM_LEVEL_TOOLTIP tooltip_level_data[TOOLTIP_LEVEL_SIZE];
extern _ITEM_TOOLTIP_TEXT tooltip_text_data[TOOLTIP_TEXT_SIZE];

extern std::map<int, _ITEM_TOOLTIP> m_ItemToolTipData;
extern std::map<int, _ITEM_LEVEL_TOOLTIP> m_ItemLevelToolTipData;
extern std::map<int, _ITEM_TOOLTIP_TEXT> m_ItemToolTipTextData;
