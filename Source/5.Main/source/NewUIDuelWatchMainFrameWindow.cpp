...
bool CNewUIDuelWatchMainFrameWindow::Render()
{
	...
	g_pRenderText->RenderText(ptOrigin.x + DisplayWinMid - 80, ptOrigin.y + 36, g_DuelMgr.GetDuelPlayerID(DUEL_HERO), 55, 0, RT3_SORT_CENTER);
	g_pRenderText->RenderText(ptOrigin.x + DisplayWinMid + 25, ptOrigin.y + 36, g_DuelMgr.GetDuelPlayerID(DUEL_ENEMY), 55, 0, RT3_SORT_CENTER);
