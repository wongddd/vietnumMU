...
void CCreditWin::RenderControls()
{
	...
	case 2:
		...
		g_pRenderText->RenderText(DisplayWinMid, 72, m_aCredit[m_anTextIndex[CRW_INDEX_NAME1]].szName,nTextBoxWidth, 0, RT3_SORT_CENTER);
		break;
	case 3:
	...
	case 4:
		...
		g_pRenderText->RenderText(DisplayWinMid, 72, m_aCredit[m_anTextIndex[CRW_INDEX_NAME2]].szName,nTextBoxWidth, 0, RT3_SORT_CENTER);
