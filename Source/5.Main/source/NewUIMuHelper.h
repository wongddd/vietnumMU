...
namespace SEASON3B
{
    ...
    public:
		...
		void UpdateBtnData(int NumBtn);
		void UpdateCheckBoxData(int NumBtn,int State);
		void SetCheckBox(int Number, bool State);
		void SetConfigData();
    ...
    public:
        ...
        bool CheckMouseSelectSkill();
		HELPER_STRUCT DataAutoMu; //Conffig
		HELPER_STRUCT Helper; //Save and Recv
		void ResetConfig();
		void LoadConfig(BYTE* Data);
		void SaveConfig();

		void RenderConfigExtra();
