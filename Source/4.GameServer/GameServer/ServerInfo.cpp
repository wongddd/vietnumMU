...
#endif
	gCustomMonterPoint.Load(gPath.GetFullPath("Custom\\CustomMonterPoint.xml"));
#if (CongHuongV2)
	gCBCongHuong.CH_LoadConfigXML(gPath.GetFullPath("Custom\\CustomCongHuong.xml"));
#endif
#if(CB_HUYDONGEXC)
	gBHuyDongExc.LoadConfigXML(gPath.GetFullPath("Custom\\HuyDongExc.xml"));
#endif
#if(CB_VIP_CHAR)
...
#if(DANH_HIEU_NEW)
	//	gDanhHieu.Load();
	gDanhHieu.Load1(gPath.GetFullPath("Custom\\DanhHieu.txt"));
#endif
#if (CUSTOM_BCHOTROI)
...
void CServerInfo::ReadChaosMixInfo(char* section,char* path) // OK
{
	...
	this->m_TatBatSoiTCPT = GetPrivateProfileInt(section, "TatBatSoiTCPT", 1, path);
	...
	//Sói vàng
	this->m_TatBatSoiHK = GetPrivateProfileInt(section, "TatBatSoiHK", 1, path);
...
void CServerInfo::ReadCharacterInfo(char* section,char* path) // OK
{
	...
	//---DW
	this->ChinhDameQuayRongDW = GetPrivateProfileInt(section, "ChinhDameQuayRongDW", 100, path);

	this->ChinhDameMuaBangTuyetDW = GetPrivateProfileInt(section, "ChinhDameMuaBangTuyetDW", 100, path);

	this->ChinhDameMuaSaoBangDW = GetPrivateProfileInt(section, "ChinhDameMuaSaoBangDW", 100, path);

	this->ChinhDameCotLuaDW = GetPrivateProfileInt(section, "ChinhDameCotLuaDW", 100, path);

	this->ChinhDameMuaDocToDW = GetPrivateProfileInt(section, "ChinhDameMuaDocToDW", 100, path);

	this->ChinhDameMuaDocDW = GetPrivateProfileInt(section, "ChinhDameMuaDocDW", 100, path);
	//---

	//---MG
	this->ThoiGianLamChamPhayMG = GetPrivateProfileInt(section, "ThoiGianLamChamPhayMG", 0, path);

	this->TiLeLamChamPhayMG = GetPrivateProfileInt(section, "TiLeLamChamPhayMG", 0, path);

	this->ChinhDamePhayMG = GetPrivateProfileInt(section, "ChinhDamePhayMG", 0, path);

	this->ChinhDameHoaDiemMG = GetPrivateProfileInt(section, "ChinhDameHoaDiemMG", 100, path);

	this->ChinhDameChemLuaMG = GetPrivateProfileInt(section, "ChinhDameChemLuaMG", 100, path);

	this->ChinhDameBaoDienMG = GetPrivateProfileInt(section, "ChinhDameBaoDienMG", 100, path);

	this->ChinhDameQuayRongMG = GetPrivateProfileInt(section, "ChinhDameQuayRongMG", 100, path);

	this->ChinhDameCotLuaMG = GetPrivateProfileInt(section, "ChinhDameCotLuaMG", 100, path);

	this->ChinhDameMuaDocToMG = GetPrivateProfileInt(section, "ChinhDameMuaDocToMG", 100, path);

	this->ChinhDameMuaDocMG = GetPrivateProfileInt(section, "ChinhDameMuaDocMG", 100, path);

	this->ChinhDameMuaSaoBangMG = GetPrivateProfileInt(section, "ChinhDameMuaSaoBangMG", 100, path);

	//---DK
	this->ChinhDameXoayKiemDK = GetPrivateProfileInt(section, "ChinhDameXoayKiemDK", 100, path);

	this->ChinhDameDamGioDK = GetPrivateProfileInt(section, "ChinhDameDamGioDK", 100, path);

	this->ChinhDameChemBangDK = GetPrivateProfileInt(section, "ChinhDameChemBangDK", 100, path);

	//---DL
	this->ChinhDameHoaXichLongDL = GetPrivateProfileInt(section, "ChinhDameHoaXichLongDL", 100, path);

	this->ChinhDameHonLoanDL = GetPrivateProfileInt(section, "ChinhDameHonLoanDL", 100, path);

	this->ChinhDameHoaAmDL = GetPrivateProfileInt(section, "ChinhDameHoaAmDL", 100, path);

	//---ELF
	this->ChinhDameNguTienFE = GetPrivateProfileInt(section, "ChinhDameNguTienFE", 100, path);

	this->ChinhDameBanBangFE = GetPrivateProfileInt(section, "ChinhDameBanBangFE", 100, path);

	this->ChinhDameXuyenTamTienFE = GetPrivateProfileInt(section, "ChinhDameXuyenTamTienFE",100, path);
	...
	//---SUM
	this->ChinhDameSetLienHoanSUM = GetPrivateProfileInt(section, "ChinhDameSetLienHoanSUM",100, path);

	this->ChinhDameQuaCauDienSUM = GetPrivateProfileInt(section, "ChinhDameQuaCauDienSUM", 100, path);

	this->ChinhDameSocDienSUM = GetPrivateProfileInt(section, "ChinhDameSocDienSUM", 100, path);

	this->ChinhDameHutMauSUM = GetPrivateProfileInt(section, "ChinhDameHutMauSUM", 100, path);
...
void CServerInfo::ReadCustomInfo(char* section,char* path) // OK
{
	...
	this->m_CustommixThanhCong = GetPrivateProfileInt(section, "CustommixThanhCong", 0, path);
	this->m_CustommixThatBai = GetPrivateProfileInt(section, "CustommixThatBai", 0, path);
	...
	this->GioiHanTyLeX2SatThuong = GetPrivateProfileInt(section, "GioiHanTyLeX2SatThuong", 100, path);
	this->GioiHanTyLeX3SatThuong = GetPrivateProfileInt(section, "GioiHanTyLeX3SatThuong", 100, path);
	this->m_GioiHanSatThuongChiMang = GetPrivateProfileInt(section, "GioiHanSatThuongChiMang", 100, path);
	this->m_GioiHanSatThuongHoanHao = GetPrivateProfileInt(section, "GioiHanSatThuongHoanHao", 100, path);
	this->m_GioiHanLoaiBoPhongThu = GetPrivateProfileInt(section, "GioiHanLoaiBoPhongThu", 100, path);
	this->m_GioiHanGiamSatThuong = GetPrivateProfileInt(section, "GioiHanGiamSatThuong", 100, path);
...
void CServerInfo::ReadCustomConfig(char* section, char* path) // OK
{
	...
	this->ThoiGianDameDocDW = GetPrivateProfileInt(section, "ThoiGianDameDocDW",5, path);
	this->SkillDocDW		= GetPrivateProfileInt(section, "SkillDocDW", 0, path);
	this->TyLeRaChoangSkillMasterDamGio = GetPrivateProfileInt(section, "TyLeRaChoangSkillMasterDamGio", 10, path);
	this->ThoiGianChoangSkillMasterDamGio = GetPrivateProfileInt(section, "ThoiGianChoangSkillMasterDamGio", 10, path);
	this->m_TatQuayDo = GetPrivateProfileInt(section, "TatQuayDo", 15, path);
	this->m_CungGuildPK = GetPrivateProfileInt(section, "CungGuildPK", 0, path);
	this->m_PKLienMinh = GetPrivateProfileInt(section, "PKLienMinh", 0, path);
    ...
    this->m_TimeGiuBoss = GetPrivateProfileInt(section, "TimeGiuDmgBoss", 0, path);
	this->m_TimeGiuBossTop = GetPrivateProfileInt(section, "TimeGiuDmgTop", 0, path);
	this->m_TimeGiuBossParty = GetPrivateProfileInt(section, "TimeGiuDmgParty", 0, path);
	...
	this->m_TinhDameBoss = GetPrivateProfileInt(section, "TinhDameTong", 0, path);
}